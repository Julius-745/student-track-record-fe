...
const { siswaMeta, pelaporanMeta } = storeToRefs(dataStore)
...
<template>
  <div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <!-- Date Filter -->
      <div class="flex flex-row items-center gap-2 sm:gap-3 bg-white p-2 sm:p-3 rounded-xl border shadow-sm overflow-hidden relative">
        <div v-if="isFiltering" class="absolute inset-0 bg-white/50 backdrop-blur-[1px] z-10 flex items-center justify-center">
    ...
    <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div class="rounded-xl bg-blue-50 p-3 text-blue-600 transition-colors group-hover:bg-blue-100">
            <Users class="h-6 w-6" />
          </div>
        </div>
      ...
      <!-- Total Pelaporan -->
      <div class="group relative overflow-hidden rounded-2xl border bg-white p-6 shadow-sm transition-all hover:shadow-md">
        <div class="flex items-center justify-between">
          <div>
          ...
          <div class="rounded-xl bg-orange-50 p-3 text-orange-600 transition-colors group-hover:bg-orange-100">
      ...
      <div class="group relative overflow-hidden rounded-2xl border bg-white p-6 shadow-sm transition-all hover:shadow-md">
        <div class="flex items-center justify-between">
          ...
          <div class="rounded-xl bg-green-50 p-3 text-green-600 transition-colors group-hover:bg-green-100">
      ...
      <div class="group relative overflow-hidden rounded-2xl border bg-white p-6 shadow-sm transition-all hover:shadow-md">
        <div class="flex items-center justify-between">
          ...
          <div class="rounded-xl bg-red-50 p-3 text-red-600 transition-colors group-hover:bg-red-100">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <div class="rounded-2xl border bg-white p-6 shadow-sm flex flex-col justify-center items-center text-center">
        <div class="bg-blue-50 p-4 rounded-full mb-4">
          <FileText class="h-8 w-8 text-blue-600" />
        </div>
        <h3 class="text-lg font-bold text-gray-900">Butuh Bantuan?</h3>
        <p class="text-sm text-gray-500 mt-1">Gunakan menu di samping untuk melihat data siswa atau membuat laporan baru.</p>
        <button 
